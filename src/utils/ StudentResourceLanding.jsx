...
const StudentResourceLanding = () => {
  ...
  const videoPlaylists = [
    ...
    {
      id: 1,
      title: 'Complete Calculus Series - Differential Mathematics',
      subject: 'Mathematics',
      ...
      views: '2.1M',
      rating: 4.8,
      link: 'https://youtube.com/playlist?list=PLHlaDQr7LlT_IUb8hBfG2TTYh9sdDsdIj&si=RRUn-zBm_zUjm2hE',
    },
    // {
    //   id: 2,
    //   title: 'Linear Algebra Complete Mathematics Course',
    //   subject: 'Mathematics',
    ...
    {
      id: 10,
      title: 'Advanced Mathematics for Engineers - Statistics',
      subject: 'Mathematics',
      thumbnail: 'https://i.ytimg.com/vi/8QihetGj3pg/maxresdefault.jpg',
      channel: 'MIT OpenCourseWare',
      videos: 38,
